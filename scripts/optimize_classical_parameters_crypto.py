...
if __name__ == "__main__":
    ...
    param_grid = {
        ...
        'rsi_buy': [None, 25, 35], # [30]
        'rsi_sell': [None, 65, 75], # [70]
        'macd_fast': [8, 16, 20], # [12]
        'macd_slow': [21, 30, 34], # [26]
        'macd_signal': [None, 7, 13], # [9, 11]
        'bollinger_window': [None, 10, 15, 20], # [25]
        'bollinger_std': [1, 1.5], # [2]
